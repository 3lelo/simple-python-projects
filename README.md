# This is the harvest of five months of training, and there is much more and more. Then finally, I got the 5th place at Code Challenge Championship in Egypt :)
...
# qq = ['-','0','#','_','$','%','^','&','*',')','!','@','(','1','2','3','4','5','6','7','8','9','{','}']
# def KATEBA_to_word(s: str) -> str:
#     l = s.split(" ")
#     ans = ""
...
# t = int(input("1 is string to Katebaa\n2 is Katebaa to string\n"))
# s = input("the word\n")
# if t == 1:
#     print(word_to_KATEBA(s))
# else:
#     print(KATEBA_to_word(s))
